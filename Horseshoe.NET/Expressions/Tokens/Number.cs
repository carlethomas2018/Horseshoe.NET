...
namespace Horseshoe.NET.Expressions.Tokens
{
    ...
    public class Number : NumericBase
    {
        ...
        /// <summary>
        /// Determines if a <c>char</c> is not <c>null</c> and is an ASCII digit.
        /// </summary>
        /// <param name="c">a nullable <c>char</c></param>
        /// <returns><c>true</c> if <c>char</c> is ASCII digit</returns>
